#
# build.tcl: Tcl script for re-creating project 'microzed_custom_ip'
#
#*****************************************************************************************
...
set design_name microzed_custom_ip
...
# Create project
create_project $design_name $origin_dir/$design_name -part xc7z010clg400-1
...
if {[string equal [get_runs -quiet impl_1] ""]} {
  create_run -name impl_1 -part xc7z010clg400-1 -flow {Vivado Implementation 2020} -strategy "Vivado Implementation Defaults" -constrset constrs_1 -parent_run synth_1
} else {
